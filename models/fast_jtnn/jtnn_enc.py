...
from models.fast_jtnn.mol_tree import Vocab, MolTree
from models.fast_jtnn.nnutils import create_var, index_select_ND, index_select_sum
...
#JI         z = F.sigmoid(self.W_z(z_input))
...
#JI         pre_h = F.tanh(self.W_h(h_input))
